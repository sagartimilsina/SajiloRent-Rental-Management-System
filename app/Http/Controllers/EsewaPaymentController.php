...
class EsewaPaymentController extends Controller
{
    ...
    public function esewaPayment(Request $request)
    {
        ...
        return view('frontend.payments.esewa.payment_form', compact('formData', 'isTesting'));
    }
    ...
    public function success(Request $request)
    {
        ...
        return redirect()->route('esewa.invoice', ['transaction_uuid' => $transactionUuid])->with('success', 'Payment successful.');
    }
