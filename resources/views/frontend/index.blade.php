    ...
    <main>
        ...
        <section class=" availibility-section">
            <div class="container py-5">
                <h1 class="text-center">For rates & Availability</h1>
                <h2 class="text-center">Search for Rent property</h2>
                ...
                <form class="row g-3 justify-content-center" action="{{ route('properties.search') }}" method="GET">
                    ...
                    <div class="col-md-12 mt-4">
                        <button type="submit" class="btn btn-primary m-auto d-block">Check Availability</button>
                    </div>
                </form>
                <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                <script>
                            ...
                            <div class="content-section {{ $index == 0 ? '' : 'd-none' }}" id="{{ @$item->id }}">
                                <div class="row">
                                    ...
                                    <div class="{{ @$item->image != null ? 'col-lg-7 col-md-12' : 'col-12' }}">
                                        <p class="fs-5 mb-4 text-start" style="text-align: justify; ">
        ...
        <section class="rent-property">
            <div class="container">
                <div class="header mb-5">
                    ...
                    <p class="text-secondary fs-5 text-uppercase text-center">
