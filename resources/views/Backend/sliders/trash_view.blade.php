...
@section('title', 'Slider Trash List')
            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-primary">Sliders Trash List</h5>
                        <div class="d-flex flex-wrap align-items-center">
                            <!-- Search Form -->
                            <form action ="{{ route('sliders.trash-view') }}"
                                class="d-flex align-items-center me-3 mb-2 mb-sm-0">
                                <div class="input-group">
                                    <input type="search" id="search-input" name="search"
                                        class="form-control form-control-md" placeholder="Search sliders ..."
                            ...
                            <a href="{{ route('sliders.trash-view') }}" class="btn btn-info ms-2 shadow-sm">
                                <i class="bx bx-refresh me-1"></i>
                            </a>
                            <a href="{{ route('sliders.index') }}" class="btn btn-primary ms-2 shadow-sm">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="table border-top ">
                            ...
                            <tbody id="mock-test-table-body">
                                @if ($sliders_trash->count() > 0)
                                    @foreach ($sliders_trash as $item)
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('slider.restore', $item->id) }}"
                                                                        method="GET">
                                                                        @csrf
