            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-primary">Sub Category Trash List</h5>
                        <div class="d-flex flex-wrap align-items-center">
                            <!-- Search Form -->
                            <form action ="{{ route('subCategory.trash-view') }}"
                            ...
                            <a href="{{ route('subCategory.trash-view') }}" class="btn btn-info ms-2 shadow-sm">
                                <i class="bx bx-refresh me-1"></i>
                            </a>
                            <a href="{{ route('subCategories.index') }}" class="btn btn-primary ms-2 shadow-sm">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="table border-top ">
                            ...
                            <tbody id="mock-test-table-body">
                                @if ($categories_trash->count() > 0)


                                    @foreach ($categories_trash as $item)
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('subCategory.restore', $item->id) }}"
                                                                        method="GET">
                                                                        @csrf
