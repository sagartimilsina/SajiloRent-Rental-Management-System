            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-primary">Category Trash List</h5>
                        <div class="d-flex flex-wrap align-items-center">
                            <!-- Search Form -->
                            <form action ="{{ route('category.trash-view') }}"
                            ...
                            <a href="{{ route('category.trash-view') }}" class="btn btn-info ms-2 shadow-sm">
                                <i class="bx bx-refresh me-1"></i>
                            </a>
                            <a href="{{ route('categories.index') }}" class="btn btn-primary ms-2 shadow-sm">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('category.restore', $item->id) }}"
                                                                        method="GET">
                                                                        @csrf
