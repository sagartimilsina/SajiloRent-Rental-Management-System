                    ...
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a
                                    ...
                                    class="underline text-gray-900 dark:text-white">Firebase Authentication</a></div>
                        </div>
                        <div class="ml-12">
                                ...
                                <form class="w-full max-w-sm" style="display: block;" id="phone_input">
                                    ...
                                    <div class="flex items-center border-b border-teal-500 py-2">
                                        ...
                                        <button
                                            ...
                                            type="button" onclick="sendOTP();" disabled id="send_otp">
                                            Send OTP
                                        </button>
                                    </div>
                                </form>
                                <form class="w-full max-w-sm" style="display: none;" id="verification_input">
                                    <div class="flex items-center border-b border-teal-500 py-2">
                                        ...
                                        <input id="verification_code"
                                            class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                                            type="text" placeholder="Enter OTP" aria-label="Verification code">
                                        <button
                                            class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded"
