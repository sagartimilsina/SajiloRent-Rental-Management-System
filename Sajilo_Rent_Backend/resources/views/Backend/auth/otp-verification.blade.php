...
<div class="wrapper">
    ...
    <form id="otpForm" action="{{ route('employee.otp.verification.post') }}" method="POST">
        ...
        <div class="row">
            <p>Didn't receive the OTP? <a href="{{ route('employee.resend.otp') }}" class="resend-link">Resend</a>
            </p>
        </div>
    </form>
