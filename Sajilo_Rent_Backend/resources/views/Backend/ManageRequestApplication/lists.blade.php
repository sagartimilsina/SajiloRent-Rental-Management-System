                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="modalToggle{{ $item->id }}"
                                                    aria-labelledby="modalToggleLabel{{ $item->id }}" tabindex="-1"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="modalToggleLabel{{ $item->id }}">View Request
                                                                ...
                                                                <div class="accordion" id="userTypeAccordion">
                                                                    ...
                                                                    <div class="accordion-item">
                                                                        <h2 class="accordion-header"
                                                                            ...
                                                                            <button class="accordion-button text-danger"
                                                ...
                                                <div class="modal fade" id="modalToggle2{{ $item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="modalToggleLabel{{ $item->id }}"2">Approve the
                                                                    Application</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <form
                                                                ...
                                                                @method('PATCH')
                                                                <div class="modal-body">
                                                                    <h6>Are you sure you want to approve this application ?
                                                                    </h6>
                                                                    <div class="mb-3">
